...
#    dodgecoin = str(choice(randodge)) + "Sadness !"

    scenes = []
    effects = [
        Print(screen, ColourImageFile(screen, "./Tmp/wow.png",
                                           screen.height-2), 0,
			stop_frame=100),
	Print(screen,
                        Rainbow(screen, FigletText("Wow !\nSuch Deception !\nVery Sad !\nMany Sucks !\nSo Mean !\nMuch Cry !\nFull Failure !", font="basic")),
                        y=screen.height // 9 - 2),
...
def STOPEVERYTHING(screen):
	    scenes = []
	    effects = [
	        Print(screen, ColourImageFile(screen, "./Tmp/th3j3st3r.gif",
	                                      screen.height-20), 18,
	              stop_frame=100),
		Print(screen,
