...
def signal_handler(signal, frame):
	...
	if exit == 0:
		...
		if len(retweetlist) > 1:
			print "There are %i items in Retweet list ."
			allok = 2
			Retweet()
