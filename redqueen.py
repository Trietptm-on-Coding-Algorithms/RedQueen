...
#	print Fig.renderText('Checking if this Tweet contains any forbidden terms:')
	...
	for forbid in banlist:
	    if Banned == 0:
		if str(forbid.lower()) in str(tweet.lower()):
