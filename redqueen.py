	...
	print
	    ...
	    if currentdate.day != 1:
                if TimeFinal.month != currentdate.month:
                                        Fig = Figlet(font='basic')
                                        print
                                        print Fig.renderText('WAY TOO TOO OLD !')
                                        print
                                        Banned = 1
                                        time.sleep(1)
        except Exception as e:
