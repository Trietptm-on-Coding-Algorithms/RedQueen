...
def credits(screen):
	...
	updatecalltxt = "Total Update Calls : ",str(updatecall)

	totalcalltxt =  "Total Calls  : ",str(totalcall)

	totalupdatecalltxt = "Total Update Calls : ",str(totalupdatecall)

	banppltxt = "Total Banned (Users): ",str(len(banppl))

	bandoubletxt = "Total Banned (Double): ",str(len(bandouble))

	banlisttxt = "Total Banned (Words): ",str(len(banlist))

	Friendstxt = "Total Nbr of friend: ",str(len(Friends))

	Followingtxt = "Total Users Followed: ",str(len(Following))

	Keywordstxt = "Total Nbr of Keywords: ",str(len(Keywords))

	moyscoretxt = "Total Tweets collected : ",str(len(moyscore))
	...
	if timer(1) < time2wait:
	    ...
	    effects = [
	        ...
	        Mirage(
	            screen,
	            FigletText("Total Banned (Score):"),
	            screen.height + 48,
	            Screen.COLOUR_GREEN),
	
	        Mirage(
	            screen,
	            FigletText("Total Banned (Language):"),
	            screen.height + 56,
	            Screen.COLOUR_GREEN),
	        ...
	        Mirage(
	            screen,
	            FigletText("Total Banned (No Keywords) :"),
	            screen.height + 64,
	            Screen.COLOUR_GREEN),
	
	        Mirage(
	            screen,
	            FigletText("Total Banned (No Results):"),
	            screen.height + 72,
	            Screen.COLOUR_GREEN),
	
	        Mirage(
	            screen,
	            FigletText("Total Banned (Too old):"),
	            screen.height + 80,
	            Screen.COLOUR_GREEN),
	
	        Mirage(
	            screen,
	            FigletText("Total Banned (FF):"),
	            screen.height + 88,
	            Screen.COLOUR_GREEN),
	    ...
	    scenes.append(Scene(effects, (screen.height + 328) * 3))
...
Minwords = len(Keywords)/400
Maxwords = len(Keywords)/200
