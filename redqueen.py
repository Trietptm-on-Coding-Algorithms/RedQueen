...
def credits(screen):
	...
	banppltxt = "Total Nbr of Banned Users: ",str(len(banppl))

	bandoubletxt = "Total Banned (Double): ",str(totalalrdysnd)

	banlisttxt = "Total Nbr of Banned Words: ",str(len(banlist))
	...
	totalnokeywordtxt = "Total Banned (No Keywords): "
