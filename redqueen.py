...
def credits(screen):
	...
	if timer(1) < time2wait:
	    ...
	    scenes.append(Scene(effects, (screen.height + 408) * 3))
...
#	print Fig.renderText('Checking if this Tweet contains any forbidden terms:')
	...
	if Banned == 0:
		...
		if twtbyuser.count(sender) >= 2:
                        ...
                        Fig = Figlet(font='cybermedium')
                        print Fig.renderText('Nbr of tweets for this user : ',str(twtbyuser.count(sender)))
                        print "*=*=*=*=*=*=*=*=*=*"
			time.sleep(0.3)
	...
	if 'retweet_count' in tweet and tweet['retweet_count'] != 0:
			...
			if tweet['retweet_count'] > 2 and tweet['retweet_count'] <= 10:
				...
				time.sleep(0.5)
                                ...
                                print
                                Fig = Figlet(font='cybermedium')
                                print Fig.renderText('No Retweet sorry')
                                print
                                print
                                Fig = Figlet(font='cybermedium')
                                print
